...
function populateProjects(result) {
  ...
  $(".prevent").click(function (event) {
    ...
    iziToast.error({
      title: "Грешка",
      message: "За да можеш да видиш този проект трябва първо да влезеш в акаунта си",
      position: "topRight"
    });
  });
