...
function sendGetPages(city, skill, interest) {
  ...
  // if (userCategory === "            Търси за: " || userCategory === "Всички" || userCategory === "                    Търси за: ") {
  //   userCategory = "";
  // }
...
function populateUsers(result) {
  ...
  $(".prevent").click(function (event) {
    ...
    iziToast.error({
      title: "Грешка",
      message: "За да можеш да видиш този профил трябва първо да влезеш в акаунта си",
      position: "topRight"
    });
  });
